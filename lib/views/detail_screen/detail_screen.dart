...
import 'package:mini_project/views/widgets/rating_star.dart';
          ...
          child: Row(
            ...
            children: [
              Container(
                height: 60,
                width: 180,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),border: Border.all(color: AppColor.PurpleColor)),
                child: Center(child: Text('Add to Cart',style: TextStyle(fontSize: 18,color: AppColor.PurpleColor),)),
              ),
              Container(
                height: 60,
                width: 180,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: AppColor.PurpleColor),
      ...
      body: CustomScrollView(
        slivers: <Widget>[
          SliverAppBar(
            ...
            expandedHeight: 350,
            actionsIconTheme: const IconThemeData(color: Color(0xFF4C53A5),weight: 5),
            actions: [
              CircleAvatar(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text("\$${widget.price}/KG",style: TextStyle(color: AppColor.PurpleColor,fontSize: 20,fontWeight: FontWeight.bold)),
                                const SizedBox(
                                  width: 25,
                                ),
                                Container(
                            ...
                            !isExpand ? const Text("Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nullam quis risus eget urna mollis ornare vel eu leo.",
                              style: TextStyle(color: Colors.grey,fontSize: 18)
                              ,) : const Divider(color: Colors.grey,height: 20,thickness: 1.5,),
                            Row(
                              children: [
